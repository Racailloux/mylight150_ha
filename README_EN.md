...
4. Copy all files from the `custom_components/mylight150_ha/` directory in this repository into the `mylight150` directory.
...
| `sensor.mylight150_<installation_code>_energy_prod_to_msb`      | Virtual battery energy in since integration installation                 | kWh  | `total_increasing` |
...
| `sensor.mylight150_<installation_code>_energy_conso_from_msb`   | Virtual battery energy out since integration installation                | kWh  | `total_increasing` |
...
| | | | |
| `sensor.mylight150_<installation_code>_pricing_mode`            | Current pricing mode, depending on the contract.                         |  -   | `text`             |
...
* [hassio MyLight integration](https://github.com/acesyde/hassio_mylight_integration) : MyLight system integration for previous API from MtLight System (MYHome)
